...
def gaussian_filter_bank(M, N, J, sigma_0, fourier=True):
    """
        ...
        gaussians : ndarray
            ...
            Gaussian filters.
    """
    gaussians = np.zeros((J + 1, M, N), dtype='complex64')
    for j in range(J + 1):
        sigma = sigma_0 * 2 ** j
        gaussians[j, ...] = gaussian_2d(M, N, sigma, fourier=fourier)
    return gaussians


def gaussian_2d(M, N, sigma, fourier=True):
    """
